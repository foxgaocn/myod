class OrderItemsController < ApplicationController
  ...
  def create
    ...
    unless(order_item_params[:product_id].present?)
      product = Product.where(name: product_name, user_id: user_id)
  ...
  private
    ...
    def order_item_params
      unless(@order_item_params)
        @order_item_params = params.require(:order_item).permit(:product_name, :product_id, :client_id, :quantity, :status)
